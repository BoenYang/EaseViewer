...
public class cameraToPdf extends Activity{
	protected void onCreate(Bundle savedInstanceState) {
		...
		Bitmap bitmap = getDiskBitmap("/sdcard/myImage/111.jpg");
		...
		confirmBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				PngToPdf.Pdf("/sdcard/myImage/111.jpg", "/sdcard/myImage/111.pdf");
				Toast.makeText(getApplicationContext(), "转换成功！",
						Toast.LENGTH_SHORT).show();
//				Intent intent = new Intent();
//				intent.setClass(cameraToPdf.this, MainActivity.class);
//				cameraToPdf.this.startActivity(intent);
